      ...
      <div className="flex flex-row justify-center">
        <div className="form-control">
          <label className="swap swap-rotate">
            <input type="checkbox" className="theme-controller" value="black" onClick={toggleTheme} />
            ...
            <svg className="swap-off fill-current w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" onClick={toggleTheme}>
